    ...
    >
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Scroll Indicator */}
          <div className="flex justify-center mt-12 fade-in-up" style={{ animationDelay: "0.6s" }}>
            <button
              onClick={handleScrollToAbout}
              className="p-2 rounded-full border border-border hover:border-primary transition-colors animate-bounce"
            >
